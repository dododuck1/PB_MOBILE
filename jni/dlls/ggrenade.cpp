...
CGrenade *CGrenade::ShootRpg(entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, int iTeam, unsigned short usEvent)
{
	CGrenade *pGrenade = CreateClassPtr<CGrenade>();
	pGrenade->Spawn();
	...
	SET_MODEL(ENT(pGrenade->pev), "models/w_rpg.mdl");
	pGrenade->pev->dmg = 100.0f;
